...
module SecretSheath
  ...
  class App < Roda
    ...
    FONT_SRC = %w[https://cdn.jsdelivr.net https://fonts.gstatic.com https://maxcdn.bootstrapcdn.com].freeze
    SCRIPT_SRC = %w[https://cdn.jsdelivr.net].freeze
    STYLE_SRC = %w[https://bootswatch.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://fonts.googleapis.com https://maxcdn.bootstrapcdn.com].freeze
